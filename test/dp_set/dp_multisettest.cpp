...
void dp_multisettest::test01()
{
	...
	// copy constructor
	dr_multiset<test*>		p0( lr );
	const dr_multiset<test*>	c0( lr );
	lr.insert( &t1 );
	dr_multiset<test*>		p1( lr );
	const dr_multiset<test*>	c1( lr );
	lr.insert( &t2 );
	lr.insert( &t3 );
	lr.insert( &t3 );
	lr.insert( &t3 );
	lr.insert( &t4 );
	lr.insert( &t5 );
	dr_multiset<test*>		p5( lr );
	const dr_multiset<test*>	c5( lr );
	...
	// move constructor
	{
		dr_multiset<test*>   lx = lr;
		dr_multiset<test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dr_multiset<test*>( { &t5, &t5, &t2 } );		// move assignment by r-value
	...
	{
		dr_multiset<test*>   lx = p5;
		dr_multiset<test*>::iterator	i = lx.find( &t4 );

		dr_multiset<test*>   x3( lx.begin(), i );
		AssertTrue( check_multiset( x3, { &t1, &t2, &t3, &t3, &t3 } ));
		dr_multiset<test*>   x0( i, i );
		AssertTrue( x0.empty());
		dr_multiset<test*>   x1( i, lx.end());
	...
	// initializer constructor/assignment operator
	{
		dr_multiset<test*>   lx = p5;
		dr_multiset<test*>   x0 { };
		dr_multiset<test*>   x1 { &t1 };
		dr_multiset<test*>   x5 { &t1, &t2, &t3, &t3, &t3, &t4, &t5 };
...
void dp_multisettest::test03()
{
	...
	// default constructor
	dr_multiset<const char[]>		lr;
	AssertTrue( check_multiset( lr, { } ));

	// copy constructor
	dr_multiset<const char[]>		p0( lr );
	const dr_multiset<const char[]>	c0( lr );
	lr.insert( s1 );
	dr_multiset<const char[]>		p1( lr );
	const dr_multiset<const char[]>	c1( lr );
	lr.insert( s2 );
	lr.insert( s3 );
	lr.insert( s3 );
	lr.insert( s3 );
	lr.insert( s4 );
	lr.insert( s5 );
	dr_multiset<const char[]>		p5( lr );
	const dr_multiset<const char[]>	c5( lr );
	...
	// move constructor
	{
		dr_multiset<const char[]>   lx = lr;
		dr_multiset<const char[]>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dr_multiset<const char[]>( { s5, s5, s2 } );		// move assignment by r-value
	...
	// iterator constructor
	{
		dr_multiset<const char[]>   lx = p5;
		dr_multiset<const char[]>::iterator	i = lx.find( s4 );

		dr_multiset<const char[]>   x3( lx.begin(), i );
		AssertTrue( check_multiset( x3, { s1, s2, s3, s3, s3 } ));
		dr_multiset<const char[]>   x0( i, i );
		AssertTrue( x0.empty());
		dr_multiset<const char[]>   x1( i, lx.end());
		AssertTrue( check_multiset( x1, { s4, s5 } ));
	}
	// initializer constructor/assignment operator
	{
		dr_multiset<const char[]>   lx = p5;
		dr_multiset<const char[]>   x0 { };
		dr_multiset<const char[]>   x1 { s1 };
		dr_multiset<const char[]>   x5 { s1, s2, s3, s3, s3, s4, s5 };
...
void dp_multisettest::test05()
{
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dr_multiset<test[]>( { v5, v5, v2 } );		// move assignment by r-value
	...
	{
		dr_multiset<test[]>   lx = p5;
		dr_multiset<test[]>::iterator	i = lx.find( v4 );
	...
	// initializer constructor/assignment operator
	{
		dr_multiset<test[]>   lx = p5;
		dr_multiset<test[]>   x0 { };
		dr_multiset<test[]>   x1 { v1 };
		dr_multiset<test[]>   x5 { v1, v2, v3, v3, v3, v4, v5 };
...
void dp_multisettest::test07()
{
	...
	// default constructor
	dr_multiset<test[3]>		lr;
	AssertTrue( check_multiset( lr, { } ));

	// copy constructor
	dr_multiset<test[3]>		p0( lr );
	const dr_multiset<test[3]>	c0( lr );
	lr.insert( w1 );
	dr_multiset<test[3]>		p1( lr );
	const dr_multiset<test[3]>	c1( lr );
	lr.insert( w2 );
	lr.insert( w3 );
	lr.insert( w3 );
	lr.insert( w3 );
	lr.insert( w4 );
	lr.insert( w5 );
	dr_multiset<test[3]>		p5( lr );
	const dr_multiset<test[3]>	c5( lr );
	...
	// move constructor
	{
		dr_multiset<test[3]>   lx = lr;
		dr_multiset<test[3]>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dr_multiset<test[3]>( { w5, w5, w2 } );		// move assignment by r-value
	...
	// iterator constructor
	{
		dr_multiset<test[3]>   lx = p5;
		dr_multiset<test[3]>::iterator	i = lx.find( w4 );

		dr_multiset<test[3]>   x3( lx.begin(), i );
		AssertTrue( check_multiset( x3, { w1, w2, w3, w3, w3 } ));
		dr_multiset<test[3]>   x0( i, i );
		AssertTrue( x0.empty());
		dr_multiset<test[3]>   x1( i, lx.end());
		AssertTrue( check_multiset( x1, { w4, w5 } ));
	}
	// initializer constructor/assignment operator
	{
		dr_multiset<test[3]>   lx = p5;
		dr_multiset<test[3]>   x0 { };
		dr_multiset<test[3]>   x1 { w1 };
		dr_multiset<test[3]>   x5 { w1, w2, w3, w3, w3, w4, w5 };
...
void dp_multisettest::test0A()
{
	...
	dr_multiset<test*>      s = { &t1, &t2, &t5, &t8, &t4, &t2, &t3, &t6, &t3, &t4, &t5, &t4, &t4, &t1, &t2 };
	...
	dr_multiset<test*>		      l1, r1, l2, r2, l3, r3, l4, r4, l5, r5;
	dr_multiset<test*>::iterator    b, e;
...
void dp_multisettest::test0C()
{
	...
	dr_multiset<const char[]>      s = { s1, s2, s5, s8, s4, s2, s3, s6, s3, s4, s5, s4, s4, s1, s2 };
	...
	dr_multiset<const char[]>		      l1, r1, l2, r2, l3, r3, l4, r4, l5, r5;
	dr_multiset<const char[]>::iterator    b, e;
...
void dp_multisettest::test0E()
{
	...
	dr_multiset<test[]>      s = { v1, v2, v5, v8, v4, v2, v3, v6, v3, v4, v5, v4, v4, v1, v2 };
...
void dp_multisettest::test10()
{
	...
	dr_multiset<test[3]>      s = { w1, w2, w5, w8, w4, w2, w3, w6, w3, w4, w5, w4, w4, w1, w2 };
	...
	dr_multiset<test[3]>		      l1, r1, l2, r2, l3, r3, l4, r4, l5, r5;
	dr_multiset<test[3]>::iterator    b, e;
...
void dp_multisettest::test13()
{
	...
	dr_multiset<test*>	m1 = { &t1, &t2 };
	dr_multiset<test*>	m2;
	dr_multiset<test*>	m3 = { &t2, &t3, &t3, &t3, &t5 };

	// emplace
	{
		typedef typename dr_multiset<test*>::iterator			iterator;
	...
	// erase
	{
		dr_multiset<test*>	p { &t1, &t2, &t5, &t8, &t4, &t2, &t3, &t6, &t3, &t4, &t5, &t4, &t4, &t1, &t2, nullptr };
		dr_multiset<test*>	p1( p );
		...
		dr_multiset<test*>	q1( p );
		dr_multiset<test*>	q2( p );
		dr_multiset<test*>	q3( p );
		dr_multiset<test*>	q4( p );
...
void dp_multisettest::test15()
{
	...
	dr_multiset<const char[]>	m1 = { s1, s2 };
	dr_multiset<const char[]>	m2;
	dr_multiset<const char[]>	m3 = { s2, s3, s3, s3, s5 };

	// emplace
	{
		typedef typename dr_multiset<const char[]>::iterator			iterator;

		dr_multiset<const char[]>	pm;
		dr_multiset<const char[]>	pi;
		iterator		r;
		iterator		j = pi.begin();
	...
	{
		dr_multiset<const char[]>     pm;
		dr_multiset<const char[]>     il;
		dr_multiset<const char[]>     it;
	...
	// erase
	{
		dr_multiset<const char[]>	p { s1, s2, s5, s8, s4, s2, s3, s6, s3, s4, s5, s4, s4, s1, s2, nullptr };
		dr_multiset<const char[]>	p1( p );
		...
		dr_multiset<const char[]>	q1( p );
		dr_multiset<const char[]>	q2( p );
		dr_multiset<const char[]>	q3( p );
		dr_multiset<const char[]>	q4( p );
...
void dp_multisettest::test17()
{
	...
	dr_multiset<test[]>	m1 = { v1, v2 };
	dr_multiset<test[]>	m2;
	dr_multiset<test[]>	m3 = { v2, v3, v3, v3, v5 };
	...
	// erase
	{
		dr_multiset<test[]>	p { v1, v2, v5, v8, v4, v2, v3, v6, v3, v4, v5, v4, v4, v1, v2, nullptr };
		dr_multiset<test[]>	p1( p );
...
void dp_multisettest::test19()
{
	...
	dr_multiset<test[3]>	m1 = { w1, w2 };
	dr_multiset<test[3]>	m2;
	dr_multiset<test[3]>	m3 = { w2, w3, w3, w3, w5 };

	// emplace
	{
		typedef typename dr_multiset<test[3]>::iterator			iterator;

		dr_multiset<test[3]>	pm;
		dr_multiset<test[3]>	pi;
		iterator		r;
		iterator		j = pi.begin();
	...
	{
		dr_multiset<test[3]>     pm;
		dr_multiset<test[3]>     il;
		dr_multiset<test[3]>     it;
	...
	// erase
	{
		dr_multiset<test[3]>	p { w1, w2, w5, w8, w4, w2, w3, w6, w3, w4, w5, w4, w4, w1, w2, nullptr };
		dr_multiset<test[3]>	p1( p );
		...
		dr_multiset<test[3]>	q1( p );
		dr_multiset<test[3]>	q2( p );
		dr_multiset<test[3]>	q3( p );
		dr_multiset<test[3]>	q4( p );
...
void dp_multisettest::test1C()
{
	...
	dr_multiset<test*>	     pm = { &t1, &t2, &t3, &t3, &t3, &t5 };
	{
		dr_multiset<test*>::iterator   i;
		dr_multiset<test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dr_multiset<test*>::iterator( i );
			if ( c == 2 ) {
	...
	{
		dr_multiset<test*>::reverse_iterator   i;
		dr_multiset<test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 4 ) k = dr_multiset<test*>::reverse_iterator( i );
			if ( c == 5 ) {
		...
		AssertEqual( c, 6 );
		AssertEqual( static_cast<dr_multiset<test*>::const_reverse_iterator>( pm.find( &t2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_multisettest::test1E()
{
	...
	dr_multiset<const char[]>	     pm = { s1, s2, s3, s3, s3, s5 };
	{
		dr_multiset<const char[]>::iterator   i;
		dr_multiset<const char[]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dr_multiset<const char[]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertEqual( *i, s3 );
	...
	{
		dr_multiset<const char[]>::reverse_iterator   i;
		dr_multiset<const char[]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 4 ) k = dr_multiset<const char[]>::reverse_iterator( i );
			if ( c == 5 ) {
				AssertNotEqual( i, pm.rend());
				AssertEqual( *i, s1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 6 );
		AssertEqual( static_cast<dr_multiset<const char[]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_multisettest::test20()
{
	...
	dr_multiset<test[]>	     pm = { v1, v2, v3, v3, v3, v5 };
	{
		dr_multiset<test[]>::iterator   i;
		dr_multiset<test[]>::const_iterator     j, k;
		unsigned			c;
	...
	}
	{
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 6 );
		AssertEqual( static_cast<dr_multiset<test[]>::const_reverse_iterator>( pm.find( v2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_multisettest::test22()
{
	...
	dr_multiset<test[3]>	     pm = { w1, w2, w3, w3, w3, w5 };
	{
		dr_multiset<test[3]>::iterator   i;
		dr_multiset<test[3]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dr_multiset<test[3]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertEqual( *i, w3 );
	...
	{
		dr_multiset<test[3]>::reverse_iterator   i;
		dr_multiset<test[3]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 4 ) k = dr_multiset<test[3]>::reverse_iterator( i );
			if ( c == 5 ) {
				AssertNotEqual( i, pm.rend());
				AssertEqual( *i, w1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 6 );
		AssertEqual( static_cast<dr_multiset<test[3]>::const_reverse_iterator>( pm.find( w2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_multisettest::test25()
{
	...
	dr_multiset<test*>      r1;
	dr_multiset<test*>      r2 = { &t1, &t2, &t3, &t3, &t3, &t5 };
	dr_multiset<test*>      r3 = { &t4, &t5 };
...
void dp_multisettest::test27()
{
	...
	dr_multiset<const char[]>      r1;
	dr_multiset<const char[]>      r2 = { s1, s2, s3, s3, s3, s5 };
	dr_multiset<const char[]>      r3 = { s4, s5 };
...
void dp_multisettest::test29()
{
	...
	dr_multiset<test[]>      r1;
	dr_multiset<test[]>      r2 = { v1, v2, v3, v3, v3, v5 };
	dr_multiset<test[]>      r3 = { v4, v5 };
...
void dp_multisettest::test2B()
{
	...
	dr_multiset<test[3]>      r1;
	dr_multiset<test[3]>      r2 = { w1, w2, w3, w3, w3, w5 };
	dr_multiset<test[3]>      r3 = { w4, w5 };
...
void dp_multisettest::test2E()
{
	...
	dr_multiset<test*>      r1 = { &t1, &t2 };
	dr_multiset<test*>      r2 = { &t1, &t2, &t3, &t3, &t3, &t5 };
	dr_multiset<test*>      r3 = { &t1, &t2, &t2 };
	dr_multiset<test*>      r4 = { &t1, &t2, &t3, &t3, &t3, &t5 };
	dr_multiset<test*>      r5;
...
void dp_multisettest::test30()
{
	...
	dr_multiset<const char[]>      r1 = { s1, s2 };
	dr_multiset<const char[]>      r2 = { s1, s2, s3, s3, s3, s5 };
	dr_multiset<const char[]>      r3 = { s1, s2, s2 };
	dr_multiset<const char[]>      r4 = { s1, s2, s3, s3, s3, s5 };
	dr_multiset<const char[]>      r5;
...
void dp_multisettest::test32()
{
	...
	dr_multiset<test[]>      r1 = { v1, v2 };
	dr_multiset<test[]>      r2 = { v1, v2, v3, v3, v3, v5 };
	dr_multiset<test[]>      r3 = { v1, v2, v2 };
	dr_multiset<test[]>      r4 = { v1, v2, v3, v3, v3, v5 };
	dr_multiset<test[]>      r5;
...
void dp_multisettest::test34()
{
	...
	dr_multiset<test[3]>      r1 = { w1, w2 };
	dr_multiset<test[3]>      r2 = { w1, w2, w3, w3, w3, w5 };
	dr_multiset<test[3]>      r3 = { w1, w2, w2 };
	dr_multiset<test[3]>      r4 = { w1, w2, w3, w3, w3, w5 };
	dr_multiset<test[3]>      r5;
