...
inline bool check_map( dp_map<K,T> const& ls,
		       std::initializer_list<typename dp_map<K,T>::value_pointer> const& ts )
{
	std::map<dp_const_pointer<K>,dp_pointer<T>>	l;

	for ( auto a : ts ) l.emplace( a.first, a.second );

	return ls == reinterpret_cast<dp_map<K,T> const&>( l );
}
...
void dp_maptest::test01()
{
	...
	// copy constructor
	rr_map<test*,test*>	p0( lr );
	const rr_map<test*,test*>	c0( lr );
	lr.emplace( &t1, &t1 );
	rr_map<test*,test*>	p1( lr );
	const rr_map<test*,test*>	c1( lr );
	lr.emplace( &t2, &t2 );
	lr.emplace( &t3, &t3 );
	lr.emplace( &t4, &t4 );
	lr.emplace( &t5, &t5 );
	rr_map<test*,test*>	p5( lr );
	const rr_map<test*,test*>	c5( lr );
	...
	// move constructor
	{
		rr_map<test*,test*>   lx = lr;
		rr_map<test*,test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rr_map<test*,test*>( {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} );	// move assignment by r-value
	...
	{
		rr_map<test*,test*>   lx = p5;
		rr_map<test*,test*>::iterator	i = lx.find( &t4 );

		rr_map<test*,test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }} ));
		rr_map<test*,test*>   x0( i, i );
		AssertTrue( x0.empty());
		rr_map<test*,test*>   x1( i, lx.end());
	...
	// initializer constructor/assignment operator
	{
		rr_map<test*,test*>   lx = p5;
		rr_map<test*,test*>   x0 { };
		rr_map<test*,test*>   x1 {{ &t1, &t1 }};
		rr_map<test*,test*>   x5 {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test02()
{
	...
	// copy constructor
	dr_map<test*,test*>	p0( lr );
	const dr_map<test*,test*>	c0( lr );
	lr.emplace( dpl( &t1 ), &t1 );
	dr_map<test*,test*>	p1( lr );
	const dr_map<test*,test*>	c1( lr );
	lr.emplace( dpl( &t2 ), &t2 );
	lr.emplace( dpl( &t3 ), &t3 );
	lr.emplace( dpl( &t4 ), &t4 );
	lr.emplace( dpl( &t5 ), &t5 );
	dr_map<test*,test*>	p5( lr );
	const dr_map<test*,test*>	c5( lr );
	...
	// move constructor
	{
		dr_map<test*,test*>   lx = lr;
		dr_map<test*,test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dr_map<test*,test*>( {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} ));
	...
	// iterator constructor
	{
		dr_map<test*,test*>   lx = p5;
		dr_map<test*,test*>::iterator	i = lx.find( &t4 );

		dr_map<test*,test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }} ));
		dr_map<test*,test*>   x0( i, i );
		AssertTrue( x0.empty());
		dr_map<test*,test*>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ &t4, &t4 }, { &t5, &t5 }} ));
	}
	// initializer constructor/assignment operator
	{
		dr_map<test*,test*>   lx = p5;
		dr_map<test*,test*>   x0 { };
		dr_map<test*,test*>   x1 {{ &t1, &t1 }};
		dr_map<test*,test*>   x5 {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test03()
{
	...
	// copy constructor
	rd_map<test*,test*>	p0( lr );
	const rd_map<test*,test*>	c0( lr );
	lr.emplace( &t1, dpl( &t1 ) );
	rd_map<test*,test*>	p1( lr );
	const rd_map<test*,test*>	c1( lr );
	lr.emplace( &t2, dpl( &t2 ) );
	lr.emplace( &t3, dpl( &t3 ) );
	lr.emplace( &t4, dpl( &t4 ) );
	lr.emplace( &t5, dpl( &t5 ) );
	rd_map<test*,test*>	p5( lr );
	const rd_map<test*,test*>	c5( lr );
	...
	// move constructor
	{
		rd_map<test*,test*>   lx = lr;
		rd_map<test*,test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<test*,test*>( {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} ));
	...
	// iterator constructor
	{
		rd_map<test*,test*>   lx = p5;
		rd_map<test*,test*>::iterator	i = lx.find( &t4 );

		rd_map<test*,test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }} ));
		rd_map<test*,test*>   x0( i, i );
		AssertTrue( x0.empty());
		rd_map<test*,test*>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ &t4, &t4 }, { &t5, &t5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rd_map<test*,test*>   lx = p5;
		rd_map<test*,test*>   x0 { };
		rd_map<test*,test*>   x1 {{ &t1, &t1 }};
		rd_map<test*,test*>   x5 {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test04()
{
	...
	// copy constructor
	dd_map<test*,test*>	p0( lr );
	const dd_map<test*,test*>	c0( lr );
	lr.emplace( dpl( &t1 ), dpl( &t1 ) );
	dd_map<test*,test*>	p1( lr );
	const dd_map<test*,test*>	c1( lr );
	lr.emplace( dpl( &t2 ), dpl( &t2 ) );
	lr.emplace( dpl( &t3 ), dpl( &t3 ) );
	lr.emplace( dpl( &t4 ), dpl( &t4 ) );
	lr.emplace( dpl( &t5 ), dpl( &t5 ) );
	dd_map<test*,test*>	p5( lr );
	const dd_map<test*,test*>	c5( lr );
	...
	// move constructor
	{
		dd_map<test*,test*>   lx = lr;
		dd_map<test*,test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dd_map<test*,test*>( {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ &t5, &t5 }, { &t3, &t3 }, { &t2, &t2 }} ));
	...
	// iterator constructor
	{
		dd_map<test*,test*>   lx = p5;
		dd_map<test*,test*>::iterator	i = lx.find( &t4 );

		dd_map<test*,test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }} ));
		dd_map<test*,test*>   x0( i, i );
		AssertTrue( x0.empty());
		dd_map<test*,test*>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ &t4, &t4 }, { &t5, &t5 }} ));
	}
	// initializer constructor/assignment operator
	{
		dd_map<test*,test*>   lx = p5;
		dd_map<test*,test*>   x0 { };
		dd_map<test*,test*>   x1 {{ &t1, &t1 }};
		dd_map<test*,test*>   x5 {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test05()
{
	...
	// default constructor
	rr_map<const char[],const char[]>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rr_map<const char[],const char[]>	p0( lr );
	const rr_map<const char[],const char[]>	c0( lr );
	lr.emplace( s1, s1 );
	rr_map<const char[],const char[]>	p1( lr );
	const rr_map<const char[],const char[]>	c1( lr );
	lr.emplace( s2, s2 );
	lr.emplace( s3, s3 );
	lr.emplace( s4, s4 );
	lr.emplace( s5, s5 );
	rr_map<const char[],const char[]>	p5( lr );
	const rr_map<const char[],const char[]>	c5( lr );
	...
	// move constructor
	{
		rr_map<const char[],const char[]>   lx = lr;
		rr_map<const char[],const char[]>   ly( std::move( lx ));
	...
	// copy assignment operator
	{
		rr_map<const char[],const char[]>   lx;
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rr_map<const char[],const char[]>( {{ s5, s5 }, { s3, s3 }, { s2, s2 }} );	// move assignment by r-value
	...
	// iterator constructor
	{
		rr_map<const char[],const char[]>   lx = p5;
		rr_map<const char[],const char[]>::iterator	i = lx.find( s4 );

		rr_map<const char[],const char[]>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, s1 }, { s2, s2 }, { s3, s3 }} ));
		rr_map<const char[],const char[]>   x0( i, i );
		AssertTrue( x0.empty());
		rr_map<const char[],const char[]>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, s4 }, { s5, s5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rr_map<const char[],const char[]>   lx = p5;
		rr_map<const char[],const char[]>   x0 { };
		rr_map<const char[],const char[]>   x1 {{ s1, s1 }};
		rr_map<const char[],const char[]>   x5 {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s4, s4 }, { s5, s5 }};
...
void dp_maptest::test06()
{
	...
	// default constructor
	rd_map<const char[],const char[]>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rd_map<const char[],const char[]>	p0( lr );
	const rd_map<const char[],const char[]>	c0( lr );
	lr.emplace( s1, strdup( s1 ) );
	rd_map<const char[],const char[]>	p1( lr );
	const rd_map<const char[],const char[]>	c1( lr );
	lr.emplace( s2, strdup( s2 ) );
	lr.emplace( s3, strdup( s3 ) );
	lr.emplace( s4, strdup( s4 ) );
	lr.emplace( s5, strdup( s5 ) );
	rd_map<const char[],const char[]>	p5( lr );
	const rd_map<const char[],const char[]>	c5( lr );
	...
	// move constructor
	{
		rd_map<const char[],const char[]>   lx = lr;
		rd_map<const char[],const char[]>   ly( std::move( lx ));
	...
	// copy assignment operator
	{
		rd_map<const char[],const char[]>   lx;
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<const char[],const char[]>( {{ s5, s5 }, { s3, s3 }, { s2, s2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ s5, s5 }, { s3, s3 }, { s2, s2 }} ));
	...
	// iterator constructor
	{
		rd_map<const char[],const char[]>   lx = p5;
		rd_map<const char[],const char[]>::iterator	i = lx.find( s4 );

		rd_map<const char[],const char[]>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, s1 }, { s2, s2 }, { s3, s3 }} ));
		rd_map<const char[],const char[]>   x0( i, i );
		AssertTrue( x0.empty());
		rd_map<const char[],const char[]>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, s4 }, { s5, s5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rd_map<const char[],const char[]>   lx = p5;
		rd_map<const char[],const char[]>   x0 { };
		rd_map<const char[],const char[]>   x1 {{ s1, s1 }};
		rd_map<const char[],const char[]>   x5 {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s4, s4 }, { s5, s5 }};
...
void dp_maptest::test07()
{
	...
	// default constructor
	rr_map<const char[],test[]>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rr_map<const char[],test[]>	p0( lr );
	const rr_map<const char[],test[]>	c0( lr );
	lr.emplace( s1, v1 );
	rr_map<const char[],test[]>	p1( lr );
	const rr_map<const char[],test[]>	c1( lr );
	lr.emplace( s2, v2 );
	lr.emplace( s3, v3 );
	lr.emplace( s4, v4 );
	lr.emplace( s5, v5 );
	rr_map<const char[],test[]>	p5( lr );
	const rr_map<const char[],test[]>	c5( lr );
	...
	// move constructor
	{
		rr_map<const char[],test[]>   lx = lr;
		rr_map<const char[],test[]>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rr_map<const char[],test[]>( {{ s5, v5 }, { s3, v3 }, { s2, v2 }} );	// move assignment by r-value
	...
	// iterator constructor
	{
		rr_map<const char[],test[]>   lx = p5;
		rr_map<const char[],test[]>::iterator	i = lx.find( s4 );

		rr_map<const char[],test[]>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, v1 }, { s2, v2 }, { s3, v3 }} ));
		rr_map<const char[],test[]>   x0( i, i );
		AssertTrue( x0.empty());
		rr_map<const char[],test[]>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, v4 }, { s5, v5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rr_map<const char[],test[]>   lx = p5;
		rr_map<const char[],test[]>   x0 { };
		rr_map<const char[],test[]>   x1 {{ s1, v1 }};
		rr_map<const char[],test[]>   x5 {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s4, v4 }, { s5, v5 }};
...
void dp_maptest::test08()
{
	...
	// default constructor
	rd_map<const char[],test[]>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rd_map<const char[],test[]>	p0( lr );
	const rd_map<const char[],test[]>	c0( lr );
	lr.emplace( s1, dpl( v1 ) );
	rd_map<const char[],test[]>	p1( lr );
	const rd_map<const char[],test[]>	c1( lr );
	lr.emplace( s2, dpl( v2 ) );
	lr.emplace( s3, dpl( v3 ) );
	lr.emplace( s4, dpl( v4 ) );
	lr.emplace( s5, dpl( v5 ) );
	rd_map<const char[],test[]>	p5( lr );
	const rd_map<const char[],test[]>	c5( lr );
	...
	// move constructor
	{
		rd_map<const char[],test[]>   lx = lr;
		rd_map<const char[],test[]>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<const char[],test[]>( {{ s5, v5 }, { s3, v3 }, { s2, v2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ s5, v5 }, { s3, v3 }, { s2, v2 }} ));
	...
	// iterator constructor
	{
		rd_map<const char[],test[]>   lx = p5;
		rd_map<const char[],test[]>::iterator	i = lx.find( s4 );

		rd_map<const char[],test[]>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, v1 }, { s2, v2 }, { s3, v3 }} ));
		rd_map<const char[],test[]>   x0( i, i );
		AssertTrue( x0.empty());
		rd_map<const char[],test[]>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, v4 }, { s5, v5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rd_map<const char[],test[]>   lx = p5;
		rd_map<const char[],test[]>   x0 { };
		rd_map<const char[],test[]>   x1 {{ s1, v1 }};
		rd_map<const char[],test[]>   x5 {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s4, v4 }, { s5, v5 }};
...
void dp_maptest::test09()
{
	...
	// default constructor
	rr_map<const char[],test[3]>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rr_map<const char[],test[3]>	p0( lr );
	const rr_map<const char[],test[3]>	c0( lr );
	lr.emplace( s1, w1 );
	rr_map<const char[],test[3]>	p1( lr );
	const rr_map<const char[],test[3]>	c1( lr );
	lr.emplace( s2, w2 );
	lr.emplace( s3, w3 );
	lr.emplace( s4, w4 );
	lr.emplace( s5, w5 );
	rr_map<const char[],test[3]>	p5( lr );
	const rr_map<const char[],test[3]>	c5( lr );
	...
	// move constructor
	{
		rr_map<const char[],test[3]>   lx = lr;
		rr_map<const char[],test[3]>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rr_map<const char[],test[3]>( {{ s5, w5 }, { s3, w3 }, { s2, w2 }} );	// move assignment by r-value
	...
	// iterator constructor
	{
		rr_map<const char[],test[3]>   lx = p5;
		rr_map<const char[],test[3]>::iterator	i = lx.find( s4 );

		rr_map<const char[],test[3]>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, w1 }, { s2, w2 }, { s3, w3 }} ));
		rr_map<const char[],test[3]>   x0( i, i );
		AssertTrue( x0.empty());
		rr_map<const char[],test[3]>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, w4 }, { s5, w5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rr_map<const char[],test[3]>   lx = p5;
		rr_map<const char[],test[3]>   x0 { };
		rr_map<const char[],test[3]>   x1 {{ s1, w1 }};
		rr_map<const char[],test[3]>   x5 {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s4, w4 }, { s5, w5 }};
...
void dp_maptest::test0A()
{
	...
	// default constructor
	rd_map<const char[],test[3]>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rd_map<const char[],test[3]>	p0( lr );
	const rd_map<const char[],test[3]>	c0( lr );
	lr.emplace( s1, dpl( w1 ) );
	rd_map<const char[],test[3]>	p1( lr );
	const rd_map<const char[],test[3]>	c1( lr );
	lr.emplace( s2, dpl( w2 ) );
	lr.emplace( s3, dpl( w3 ) );
	lr.emplace( s4, dpl( w4 ) );
	lr.emplace( s5, dpl( w5 ) );
	rd_map<const char[],test[3]>	p5( lr );
	const rd_map<const char[],test[3]>	c5( lr );
	...
	// move constructor
	{
		rd_map<const char[],test[3]>   lx = lr;
		rd_map<const char[],test[3]>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<const char[],test[3]>( {{ s5, w5 }, { s3, w3 }, { s2, w2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ s5, w5 }, { s3, w3 }, { s2, w2 }} ));
	...
	// iterator constructor
	{
		rd_map<const char[],test[3]>   lx = p5;
		rd_map<const char[],test[3]>::iterator	i = lx.find( s4 );

		rd_map<const char[],test[3]>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, w1 }, { s2, w2 }, { s3, w3 }} ));
		rd_map<const char[],test[3]>   x0( i, i );
		AssertTrue( x0.empty());
		rd_map<const char[],test[3]>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, w4 }, { s5, w5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rd_map<const char[],test[3]>   lx = p5;
		rd_map<const char[],test[3]>   x0 { };
		rd_map<const char[],test[3]>   x1 {{ s1, w1 }};
		rd_map<const char[],test[3]>   x5 {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s4, w4 }, { s5, w5 }};
...
void dp_maptest::test0B()
{
	...
	// default constructor
	rn_map<const char[],int>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rn_map<const char[],int>	p0( lr );
	const rn_map<const char[],int>	c0( lr );
	lr.emplace( s1, 1 );
	rn_map<const char[],int>	p1( lr );
	const rn_map<const char[],int>	c1( lr );
	lr.emplace( s2, 2 );
	lr.emplace( s3, 3 );
	lr.emplace( s4, 4 );
	lr.emplace( s5, 5 );
	rn_map<const char[],int>	p5( lr );
	const rn_map<const char[],int>	c5( lr );
	...
	// move constructor
	{
		rn_map<const char[],int>   lx = lr;
		rn_map<const char[],int>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rn_map<const char[],int>( {{ s5, 5 }, { s3, 3 }, { s2, 2 }} );	// move assignment by r-value
	...
	// iterator constructor
	{
		rn_map<const char[],int>   lx = p5;
		rn_map<const char[],int>::iterator	i = lx.find( s4 );

		rn_map<const char[],int>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, 1 }, { s2, 2 }, { s3, 3 }} ));
		rn_map<const char[],int>   x0( i, i );
		AssertTrue( x0.empty());
		rn_map<const char[],int>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, 4 }, { s5, 5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rn_map<const char[],int>   lx = p5;
		rn_map<const char[],int>   x0 { };
		rn_map<const char[],int>   x1 {{ s1, 1 }};
		rn_map<const char[],int>   x5 {{ s1, 1 }, { s2, 2 }, { s3, 3 }, { s4, 4 }, { s5, 5 }};
...
void dp_maptest::test0C()
{
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<const char[],test*>( {{ s5, &t5 }, { s3, &t3 }, { s2, &t2 }} );	// move assignment by r-value
	...
	// initializer constructor/assignment operator
	{
		rd_map<const char[],test*>   lx = p5;
		rd_map<const char[],test*>   x0 { };
		rd_map<const char[],test*>   x1 {{ s1, &t1 }};
		rd_map<const char[],test*>   x5 {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s4, &t4 }, { s5, &t5 }};
...
void dp_maptest::test0D()
{
	...
	// default constructor
	dd_map<const char[],test*>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	dd_map<const char[],test*>	p0( lr );
	const dd_map<const char[],test*>	c0( lr );
	lr.emplace( strdup( s1 ), dpl( &t1 ) );
	dd_map<const char[],test*>	p1( lr );
	const dd_map<const char[],test*>	c1( lr );
	lr.emplace( strdup( s2 ), dpl( &t2 ) );
	lr.emplace( strdup( s3 ), dpl( &t3 ) );
	lr.emplace( strdup( s4 ), dpl( &t4 ) );
	lr.emplace( strdup( s5 ), dpl( &t5 ) );
	dd_map<const char[],test*>	p5( lr );
	const dd_map<const char[],test*>	c5( lr );
	...
	// move constructor
	{
		dd_map<const char[],test*>   lx = lr;
		dd_map<const char[],test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dd_map<const char[],test*>( {{ s5, &t5 }, { s3, &t3 }, { s2, &t2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ s5, &t5 }, { s3, &t3 }, { s2, &t2 }} ));
	...
	// iterator constructor
	{
		dd_map<const char[],test*>   lx = p5;
		dd_map<const char[],test*>::iterator	i = lx.find( s4 );

		dd_map<const char[],test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }} ));
		dd_map<const char[],test*>   x0( i, i );
		AssertTrue( x0.empty());
		dd_map<const char[],test*>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ s4, &t4 }, { s5, &t5 }} ));
	}
	// initializer constructor/assignment operator
	{
		dd_map<const char[],test*>   lx = p5;
		dd_map<const char[],test*>   x0 { };
		dd_map<const char[],test*>   x1 {{ s1, &t1 }};
		dd_map<const char[],test*>   x5 {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s4, &t4 }, { s5, &t5 }};
...
void dp_maptest::test0E()
{
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<test[],test*>( {{ v5, &t5 }, { v3, &t3 }, { v2, &t2 }} );	// move assignment by r-value
	...
	{
		rd_map<test[],test*>   lx = p5;
		rd_map<test[],test*>::iterator	i = lx.find( v4 );
	...
	// initializer constructor/assignment operator
	{
		rd_map<test[],test*>   lx = p5;
		rd_map<test[],test*>   x0 { };
		rd_map<test[],test*>   x1 {{ v1, &t1 }};
		rd_map<test[],test*>   x5 {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v4, &t4 }, { v5, &t5 }};
...
void dp_maptest::test0F()
{
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dd_map<test[],test*>( {{ v5, &t5 }, { v3, &t3 }, { v2, &t2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ v5, &t5 }, { v3, &t3 }, { v2, &t2 }} ));
	...
	{
		dd_map<test[],test*>   lx = p5;
		dd_map<test[],test*>::iterator	i = lx.find( v4 );
	...
	// initializer constructor/assignment operator
	{
		dd_map<test[],test*>   lx = p5;
		dd_map<test[],test*>   x0 { };
		dd_map<test[],test*>   x1 {{ v1, &t1 }};
		dd_map<test[],test*>   x5 {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v4, &t4 }, { v5, &t5 }};
...
void dp_maptest::test10()
{
	...
	// default constructor
	rd_map<test[3],test*>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	rd_map<test[3],test*>	p0( lr );
	const rd_map<test[3],test*>	c0( lr );
	lr.emplace( w1, dpl( &t1 ) );
	rd_map<test[3],test*>	p1( lr );
	const rd_map<test[3],test*>	c1( lr );
	lr.emplace( w2, dpl( &t2 ) );
	lr.emplace( w3, dpl( &t3 ) );
	lr.emplace( w4, dpl( &t4 ) );
	lr.emplace( w5, dpl( &t5 ) );
	rd_map<test[3],test*>	p5( lr );
	const rd_map<test[3],test*>	c5( lr );
	...
	// move constructor
	{
		rd_map<test[3],test*>   lx = lr;
		rd_map<test[3],test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = rd_map<test[3],test*>( {{ w5, &t5 }, { w3, &t3 }, { w2, &t2 }} );	// move assignment by r-value
	...
	// iterator constructor
	{
		rd_map<test[3],test*>   lx = p5;
		rd_map<test[3],test*>::iterator	i = lx.find( w4 );

		rd_map<test[3],test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }} ));
		rd_map<test[3],test*>   x0( i, i );
		AssertTrue( x0.empty());
		rd_map<test[3],test*>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ w4, &t4 }, { w5, &t5 }} ));
	}
	// initializer constructor/assignment operator
	{
		rd_map<test[3],test*>   lx = p5;
		rd_map<test[3],test*>   x0 { };
		rd_map<test[3],test*>   x1 {{ w1, &t1 }};
		rd_map<test[3],test*>   x5 {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w4, &t4 }, { w5, &t5 }};
...
void dp_maptest::test11()
{
	...
	// default constructor
	dd_map<test[3],test*>	lr;
	AssertTrue( check_map( lr, { } ));

	// copy constructor
	dd_map<test[3],test*>	p0( lr );
	const dd_map<test[3],test*>	c0( lr );
	lr.emplace( dpl( w1 ), dpl( &t1 ) );
	dd_map<test[3],test*>	p1( lr );
	const dd_map<test[3],test*>	c1( lr );
	lr.emplace( dpl( w2 ), dpl( &t2 ) );
	lr.emplace( dpl( w3 ), dpl( &t3 ) );
	lr.emplace( dpl( w4 ), dpl( &t4 ) );
	lr.emplace( dpl( w5 ), dpl( &t5 ) );
	dd_map<test[3],test*>	p5( lr );
	const dd_map<test[3],test*>	c5( lr );
	...
	// move constructor
	{
		dd_map<test[3],test*>   lx = lr;
		dd_map<test[3],test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = dd_map<test[3],test*>( {{ w5, &t5 }, { w3, &t3 }, { w2, &t2 }} );	// move assignment by r-value
		AssertTrue( check_map( lx, {{ w5, &t5 }, { w3, &t3 }, { w2, &t2 }} ));
	...
	// iterator constructor
	{
		dd_map<test[3],test*>   lx = p5;
		dd_map<test[3],test*>::iterator	i = lx.find( w4 );

		dd_map<test[3],test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }} ));
		dd_map<test[3],test*>   x0( i, i );
		AssertTrue( x0.empty());
		dd_map<test[3],test*>   x1( i, lx.end());
		AssertTrue( check_map( x1, {{ w4, &t4 }, { w5, &t5 }} ));
	}
	// initializer constructor/assignment operator
	{
		dd_map<test[3],test*>   lx = p5;
		dd_map<test[3],test*>   x0 { };
		dd_map<test[3],test*>   x1 {{ w1, &t1 }};
		dd_map<test[3],test*>   x5 {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w4, &t4 }, { w5, &t5 }};
...
void dp_maptest::test12()
{
	...
	// copy constructor
	nd_map<int,test*>	p0( lr );
	const nd_map<int,test*>	c0( lr );
	lr.emplace( 1, dpl( &t1 ) );
	nd_map<int,test*>	p1( lr );
	const nd_map<int,test*>	c1( lr );
	lr.emplace( 2, dpl( &t2 ) );
	lr.emplace( 3, dpl( &t3 ) );
	lr.emplace( 4, dpl( &t4 ) );
	lr.emplace( 5, dpl( &t5 ) );
	nd_map<int,test*>	p5( lr );
	const nd_map<int,test*>	c5( lr );
	...
	// move constructor
	{
		nd_map<int,test*>   lx = lr;
		nd_map<int,test*>   ly( std::move( lx ));
	...
	// move assignment operator
	{
		...
		lr = p1;
		lx = nd_map<int,test*>( {{ 5, &t5 }, { 3, &t3 }, { 2, &t2 }} );	// move assignment by r-value
	...
	// iterator constructor
	{
		nd_map<int,test*>   lx = p5;
		nd_map<int,test*>::iterator	i = lx.find( 4 );

		nd_map<int,test*>   x3( lx.begin(), i );
		AssertTrue( check_map( x3, {{ 1, &t1 }, { 2, &t2 }, { 3, &t3 }} ));
		nd_map<int,test*>   x0( i, i );
		AssertTrue( x0.empty());
		nd_map<int,test*>   x1( i, lx.end());
	...
	// initializer constructor/assignment operator
	{
		nd_map<int,test*>   lx = p5;
		nd_map<int,test*>   x0 { };
		nd_map<int,test*>   x1 {{ 1, &t1 }};
		nd_map<int,test*>   x5 {{ 1, &t1 }, { 2, &t2 }, { 3, &t3 }, { 4, &t4 }, { 5, &t5 }};
...
void dp_maptest::test13()
{
	...
	rr_map<test*,test*>	pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t2, &t2 },
				  { &t3, &t3 }, { &t3, &t3 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }, { &t4, &t4 },
				  { &t4, &t4 }, { &t1, &t1 }, { &t2, &t2 }};
	rr_map<test*,test*> const& cm = pm;
	...
	rr_map<const test*,test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rr_map<test*,test*>::iterator		b, e;
	rr_map<test*,test*>::const_iterator	c, f;
...
void dp_maptest::test14()
{
	...
	dr_map<test*,test*>	pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t2, &t2 },
				  { &t3, &t3 }, { &t3, &t3 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }, { &t4, &t4 },
				  { &t4, &t4 }, { &t1, &t1 }, { &t2, &t2 }};
	dr_map<test*,test*> const& cm = pm;
	...
	rr_map<const test*,test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	dr_map<test*,test*>::iterator		b, e;
	dr_map<test*,test*>::const_iterator	c, f;
...
void dp_maptest::test15()
{
	...
	rd_map<test*,test*>	pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t2, &t2 },
				  { &t3, &t3 }, { &t3, &t3 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }, { &t4, &t4 },
				  { &t4, &t4 }, { &t1, &t1 }, { &t2, &t2 }};
	rd_map<test*,test*> const& cm = pm;
	...
	rr_map<const test*,test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rd_map<test*,test*>::iterator		b, e;
	rd_map<test*,test*>::const_iterator	c, f;
...
void dp_maptest::test16()
{
	...
	dd_map<test*,test*>	pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t2, &t2 },
				  { &t3, &t3 }, { &t3, &t3 }, { &t3, &t3 }, { &t4, &t4 }, { &t5, &t5 }, { &t4, &t4 },
				  { &t4, &t4 }, { &t1, &t1 }, { &t2, &t2 }};
	dd_map<test*,test*> const& cm = pm;
	...
	rr_map<const test*,test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	dd_map<test*,test*>::iterator		b, e;
	dd_map<test*,test*>::const_iterator	c, f;
...
void dp_maptest::test17()
{
	...
	rr_map<const char[],const char[]>	pm = {{ s1, s1 }, { s2, s2 }, { s5, s5 }, { s8, s8 }, { s4, s4 }, { s2, s2 },
				  { s3, s3 }, { s3, s3 }, { s3, s3 }, { s4, s4 }, { s5, s5 }, { s4, s4 },
				  { s4, s4 }, { s1, s1 }, { s2, s2 }};
	rr_map<const char[],const char[]> const& cm = pm;
	...
	rr_map<const char[],const char[]>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rr_map<const char[],const char[]>::iterator		b, e;
	rr_map<const char[],const char[]>::const_iterator	c, f;
...
void dp_maptest::test18()
{
	...
	rd_map<const char[],const char[]>	pm = {{ s1, s1 }, { s2, s2 }, { s5, s5 }, { s8, s8 }, { s4, s4 }, { s2, s2 },
				  { s3, s3 }, { s3, s3 }, { s3, s3 }, { s4, s4 }, { s5, s5 }, { s4, s4 },
				  { s4, s4 }, { s1, s1 }, { s2, s2 }};
	rd_map<const char[],const char[]> const& cm = pm;
	...
	rr_map<const char[],const char[]>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rd_map<const char[],const char[]>::iterator		b, e;
	rd_map<const char[],const char[]>::const_iterator	c, f;
...
void dp_maptest::test19()
{
	...
	rr_map<const char[],test[]>	pm = {{ s1, v1 }, { s2, v2 }, { s5, v5 }, { s8, v8 }, { s4, v4 }, { s2, v2 },
				  { s3, v3 }, { s3, v3 }, { s3, v3 }, { s4, v4 }, { s5, v5 }, { s4, v4 },
				  { s4, v4 }, { s1, v1 }, { s2, v2 }};
	rr_map<const char[],test[]> const& cm = pm;
	...
	rr_map<const char[],test[]>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rr_map<const char[],test[]>::iterator		b, e;
	rr_map<const char[],test[]>::const_iterator	c, f;
...
void dp_maptest::test1A()
{
	...
	rd_map<const char[],test[]>	pm = {{ s1, v1 }, { s2, v2 }, { s5, v5 }, { s8, v8 }, { s4, v4 }, { s2, v2 },
				  { s3, v3 }, { s3, v3 }, { s3, v3 }, { s4, v4 }, { s5, v5 }, { s4, v4 },
				  { s4, v4 }, { s1, v1 }, { s2, v2 }};
	rd_map<const char[],test[]> const& cm = pm;
	...
	rr_map<const char[],test[]>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rd_map<const char[],test[]>::iterator		b, e;
	rd_map<const char[],test[]>::const_iterator	c, f;
...
void dp_maptest::test1B()
{
	...
	rr_map<const char[],test[3]>	pm = {{ s1, w1 }, { s2, w2 }, { s5, w5 }, { s8, w8 }, { s4, w4 }, { s2, w2 },
				  { s3, w3 }, { s3, w3 }, { s3, w3 }, { s4, w4 }, { s5, w5 }, { s4, w4 },
				  { s4, w4 }, { s1, w1 }, { s2, w2 }};
	rr_map<const char[],test[3]> const& cm = pm;
	...
	rr_map<const char[],test[3]>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rr_map<const char[],test[3]>::iterator		b, e;
	rr_map<const char[],test[3]>::const_iterator	c, f;
...
void dp_maptest::test1C()
{
	...
	rd_map<const char[],test[3]>	pm = {{ s1, w1 }, { s2, w2 }, { s5, w5 }, { s8, w8 }, { s4, w4 }, { s2, w2 },
				  { s3, w3 }, { s3, w3 }, { s3, w3 }, { s4, w4 }, { s5, w5 }, { s4, w4 },
				  { s4, w4 }, { s1, w1 }, { s2, w2 }};
	rd_map<const char[],test[3]> const& cm = pm;
	...
	rr_map<const char[],test[3]>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rd_map<const char[],test[3]>::iterator		b, e;
	rd_map<const char[],test[3]>::const_iterator	c, f;
...
void dp_maptest::test1D()
{
	...
	rn_map<const char[],int>	pm = {{ s1, 1 }, { s2, 2 }, { s5, 5 }, { s8, 8 }, { s4, 4 }, { s2, 2 },
				  { s3, 3 }, { s3, 3 }, { s3, 3 }, { s4, 4 }, { s5, 5 }, { s4, 4 },
				  { s4, 4 }, { s1, 1 }, { s2, 2 }};
	rn_map<const char[],int> const& cm = pm;
	...
	rn_map<const char[],int>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rn_map<const char[],int>::iterator		b, e;
	rn_map<const char[],int>::const_iterator	c, f;
...
void dp_maptest::test1E()
{
	...
	rd_map<const char[],test*>	pm = {{ s1, &t1 }, { s2, &t2 }, { s5, &t5 }, { s8, &t8 }, { s4, &t4 }, { s2, &t2 },
...
void dp_maptest::test1F()
{
	...
	dd_map<const char[],test*>	pm = {{ s1, &t1 }, { s2, &t2 }, { s5, &t5 }, { s8, &t8 }, { s4, &t4 }, { s2, &t2 },
				  { s3, &t3 }, { s3, &t3 }, { s3, &t3 }, { s4, &t4 }, { s5, &t5 }, { s4, &t4 },
				  { s4, &t4 }, { s1, &t1 }, { s2, &t2 }};
	dd_map<const char[],test*> const& cm = pm;
	...
	rr_map<const char[],test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	dd_map<const char[],test*>::iterator		b, e;
	dd_map<const char[],test*>::const_iterator	c, f;
...
void dp_maptest::test20()
{
	...
	rd_map<test[],test*>	pm = {{ v1, &t1 }, { v2, &t2 }, { v5, &t5 }, { v8, &t8 }, { v4, &t4 }, { v2, &t2 },
...
void dp_maptest::test21()
{
	...
	dd_map<test[],test*>	pm = {{ v1, &t1 }, { v2, &t2 }, { v5, &t5 }, { v8, &t8 }, { v4, &t4 }, { v2, &t2 },
				  { v3, &t3 }, { v3, &t3 }, { v3, &t3 }, { v4, &t4 }, { v5, &t5 }, { v4, &t4 },
				  { v4, &t4 }, { v1, &t1 }, { v2, &t2 }};
	dd_map<test[],test*> const& cm = pm;
...
void dp_maptest::test22()
{
	...
	rd_map<test[3],test*>	pm = {{ w1, &t1 }, { w2, &t2 }, { w5, &t5 }, { w8, &t8 }, { w4, &t4 }, { w2, &t2 },
				  { w3, &t3 }, { w3, &t3 }, { w3, &t3 }, { w4, &t4 }, { w5, &t5 }, { w4, &t4 },
				  { w4, &t4 }, { w1, &t1 }, { w2, &t2 }};
	rd_map<test[3],test*> const& cm = pm;
	...
	rr_map<const test[3],test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	rd_map<test[3],test*>::iterator		b, e;
	rd_map<test[3],test*>::const_iterator	c, f;
...
void dp_maptest::test23()
{
	...
	dd_map<test[3],test*>	pm = {{ w1, &t1 }, { w2, &t2 }, { w5, &t5 }, { w8, &t8 }, { w4, &t4 }, { w2, &t2 },
				  { w3, &t3 }, { w3, &t3 }, { w3, &t3 }, { w4, &t4 }, { w5, &t5 }, { w4, &t4 },
				  { w4, &t4 }, { w1, &t1 }, { w2, &t2 }};
	dd_map<test[3],test*> const& cm = pm;
	...
	rr_map<const test[3],test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	dd_map<test[3],test*>::iterator		b, e;
	dd_map<test[3],test*>::const_iterator	c, f;
...
void dp_maptest::test24()
{
	...
	nd_map<int,test*>	pm = {{ 1, &t1 }, { 2, &t2 }, { 5, &t5 }, { 8, &t8 }, { 4, &t4 }, { 2, &t2 },
				  { 3, &t3 }, { 3, &t3 }, { 3, &t3 }, { 4, &t4 }, { 5, &t5 }, { 4, &t4 },
				  { 4, &t4 }, { 1, &t1 }, { 2, &t2 }};
	nd_map<int,test*> const& cm = pm;
	...
	nr_map<int,test*>	l1, r1, l2, r2, l3, r3, l4, r4, l5, r5, er;
	nd_map<int,test*>::iterator		b, e;
	nd_map<int,test*>::const_iterator	c, f;
...
void dp_maptest::test25()
{
	...
	typedef typename rr_map<test*,test*>::iterator		iterator;
	typedef typename rr_map<test*,test*>::const_iterator	const_iterator;

	rr_map<const test*,test*>	m1 = {{ &t1, &t1 }, { &t2, &t2 }};
	rr_map<const test*,test*>	m2;
	rr_map<const test*,test*>	m3 = {{ &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	...
	// erase
	{
		rr_map<test*,test*>     p {{ &t1, &t1 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t3, &t3 }, { nullptr, nullptr } };
		rr_map<test*,test*>     p1( p );
		...
		rr_map<test*,test*>     q1( p );
		rr_map<test*,test*>     q2( p );
		rr_map<test*,test*>     q3( p );
		rr_map<test*,test*>     q4( p );
...
void dp_maptest::test26()
{
	...
	typedef typename dr_map<test*,test*>::iterator		iterator;
	typedef typename dr_map<test*,test*>::const_iterator	const_iterator;
	...
	// erase
	{
		dr_map<test*,test*>     p {{ &t1, &t1 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t3, &t3 }, { nullptr, nullptr } };
		dr_map<test*,test*>     p1( p );
		...
		dr_map<test*,test*>     q1( p );
		dr_map<test*,test*>     q2( p );
		dr_map<test*,test*>     q3( p );
		dr_map<test*,test*>     q4( p );
...
void dp_maptest::test27()
{
	...
	typedef typename rd_map<test*,test*>::iterator		iterator;
	typedef typename rd_map<test*,test*>::const_iterator	const_iterator;
	...
	// erase
	{
		rd_map<test*,test*>     p {{ &t1, &t1 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t3, &t3 }, { nullptr, nullptr } };
		rd_map<test*,test*>     p1( p );
		...
		rd_map<test*,test*>     q1( p );
		rd_map<test*,test*>     q2( p );
		rd_map<test*,test*>     q3( p );
		rd_map<test*,test*>     q4( p );
...
void dp_maptest::test28()
{
	...
	typedef typename dd_map<test*,test*>::iterator		iterator;
	typedef typename dd_map<test*,test*>::const_iterator	const_iterator;
	...
	// erase
	{
		dd_map<test*,test*>     p {{ &t1, &t1 }, { &t5, &t5 }, { &t8, &t8 }, { &t4, &t4 }, { &t3, &t3 }, { nullptr, nullptr } };
		dd_map<test*,test*>     p1( p );
		...
		dd_map<test*,test*>     q1( p );
		dd_map<test*,test*>     q2( p );
		dd_map<test*,test*>     q3( p );
		dd_map<test*,test*>     q4( p );
...
void dp_maptest::test29()
{
	...
	typedef typename rr_map<const char[],const char[]>::iterator		iterator;
	typedef typename rr_map<const char[],const char[]>::const_iterator	const_iterator;

	rr_map<const char[],const char[]>	m1 = {{ s1, s1 }, { s2, s2 }};
	rr_map<const char[],const char[]>	m2;
	rr_map<const char[],const char[]>	m3 = {{ s2, s2 }, { s3, s3 }, { s5, s5 }};

	// emplace
	{
		rr_map<const char[],const char[]>		pm;
		rr_map<const char[],const char[]>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rr_map<const char[],const char[]>		pm;
		rr_map<const char[],const char[]>		pi;
		rr_map<const char[],const char[]>		il;
		rr_map<const char[],const char[]>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rr_map<const char[],const char[]>     p {{ s1, s1 }, { s5, s5 }, { s8, s8 }, { s4, s4 }, { s3, s3 }, { nullptr, nullptr } };
		rr_map<const char[],const char[]>     p1( p );
		...
		rr_map<const char[],const char[]>     q1( p );
		rr_map<const char[],const char[]>     q2( p );
		rr_map<const char[],const char[]>     q3( p );
		rr_map<const char[],const char[]>     q4( p );
...
void dp_maptest::test2A()
{
	...
	typedef typename rd_map<const char[],const char[]>::iterator		iterator;
	typedef typename rd_map<const char[],const char[]>::const_iterator	const_iterator;
	...
	// emplace
	{
		rd_map<const char[],const char[]>		pm;
		rd_map<const char[],const char[]>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rd_map<const char[],const char[]>		pm;
		rd_map<const char[],const char[]>		pi;
		rd_map<const char[],const char[]>		il;
		rd_map<const char[],const char[]>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rd_map<const char[],const char[]>     p {{ s1, s1 }, { s5, s5 }, { s8, s8 }, { s4, s4 }, { s3, s3 }, { nullptr, nullptr } };
		rd_map<const char[],const char[]>     p1( p );
		...
		rd_map<const char[],const char[]>     q1( p );
		rd_map<const char[],const char[]>     q2( p );
		rd_map<const char[],const char[]>     q3( p );
		rd_map<const char[],const char[]>     q4( p );
...
void dp_maptest::test2B()
{
	...
	typedef typename rr_map<const char[],test[]>::iterator		iterator;
	typedef typename rr_map<const char[],test[]>::const_iterator	const_iterator;

	rr_map<const char[],test[]>	m1 = {{ s1, v1 }, { s2, v2 }};
	rr_map<const char[],test[]>	m2;
	rr_map<const char[],test[]>	m3 = {{ s2, v2 }, { s3, v3 }, { s5, v5 }};

	// emplace
	{
		rr_map<const char[],test[]>		pm;
		rr_map<const char[],test[]>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rr_map<const char[],test[]>		pm;
		rr_map<const char[],test[]>		pi;
		rr_map<const char[],test[]>		il;
		rr_map<const char[],test[]>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rr_map<const char[],test[]>     p {{ s1, v1 }, { s5, v5 }, { s8, v8 }, { s4, v4 }, { s3, v3 }, { nullptr, nullptr } };
		rr_map<const char[],test[]>     p1( p );
		...
		rr_map<const char[],test[]>     q1( p );
		rr_map<const char[],test[]>     q2( p );
		rr_map<const char[],test[]>     q3( p );
		rr_map<const char[],test[]>     q4( p );
...
void dp_maptest::test2C()
{
	...
	typedef typename rd_map<const char[],test[]>::iterator		iterator;
	typedef typename rd_map<const char[],test[]>::const_iterator	const_iterator;
	...
	// emplace
	{
		rd_map<const char[],test[]>		pm;
		rd_map<const char[],test[]>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rd_map<const char[],test[]>		pm;
		rd_map<const char[],test[]>		pi;
		rd_map<const char[],test[]>		il;
		rd_map<const char[],test[]>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rd_map<const char[],test[]>     p {{ s1, v1 }, { s5, v5 }, { s8, v8 }, { s4, v4 }, { s3, v3 }, { nullptr, nullptr } };
		rd_map<const char[],test[]>     p1( p );
		...
		rd_map<const char[],test[]>     q1( p );
		rd_map<const char[],test[]>     q2( p );
		rd_map<const char[],test[]>     q3( p );
		rd_map<const char[],test[]>     q4( p );
...
void dp_maptest::test2D()
{
	...
	typedef typename rr_map<const char[],test[3]>::iterator		iterator;
	typedef typename rr_map<const char[],test[3]>::const_iterator	const_iterator;

	rr_map<const char[],test[3]>	m1 = {{ s1, w1 }, { s2, w2 }};
	rr_map<const char[],test[3]>	m2;
	rr_map<const char[],test[3]>	m3 = {{ s2, w2 }, { s3, w3 }, { s5, w5 }};

	// emplace
	{
		rr_map<const char[],test[3]>		pm;
		rr_map<const char[],test[3]>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rr_map<const char[],test[3]>		pm;
		rr_map<const char[],test[3]>		pi;
		rr_map<const char[],test[3]>		il;
		rr_map<const char[],test[3]>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rr_map<const char[],test[3]>     p {{ s1, w1 }, { s5, w5 }, { s8, w8 }, { s4, w4 }, { s3, w3 }, { nullptr, nullptr } };
		rr_map<const char[],test[3]>     p1( p );
		...
		rr_map<const char[],test[3]>     q1( p );
		rr_map<const char[],test[3]>     q2( p );
		rr_map<const char[],test[3]>     q3( p );
		rr_map<const char[],test[3]>     q4( p );
...
void dp_maptest::test2E()
{
	...
	typedef typename rd_map<const char[],test[3]>::iterator		iterator;
	typedef typename rd_map<const char[],test[3]>::const_iterator	const_iterator;
	...
	// emplace
	{
		rd_map<const char[],test[3]>		pm;
		rd_map<const char[],test[3]>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rd_map<const char[],test[3]>		pm;
		rd_map<const char[],test[3]>		pi;
		rd_map<const char[],test[3]>		il;
		rd_map<const char[],test[3]>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rd_map<const char[],test[3]>     p {{ s1, w1 }, { s5, w5 }, { s8, w8 }, { s4, w4 }, { s3, w3 }, { nullptr, nullptr } };
		rd_map<const char[],test[3]>     p1( p );
		...
		rd_map<const char[],test[3]>     q1( p );
		rd_map<const char[],test[3]>     q2( p );
		rd_map<const char[],test[3]>     q3( p );
		rd_map<const char[],test[3]>     q4( p );
...
void dp_maptest::test2F()
{
	...
	typedef typename rn_map<const char[],int>::iterator		iterator;
	typedef typename rn_map<const char[],int>::const_iterator	const_iterator;

	rn_map<const char[],int>	m1 = {{ s1, 1 }, { s2, 2 }};
	rn_map<const char[],int>	m2;
	rn_map<const char[],int>	m3 = {{ s2, 2 }, { s3, 3 }, { s5, 5 }};

	// emplace
	{
		rn_map<const char[],int>		pm;
		rn_map<const char[],int>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rn_map<const char[],int>		pm;
		rn_map<const char[],int>		pi;
		rn_map<const char[],int>		il;
		rn_map<const char[],int>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rn_map<const char[],int>     p {{ s1, 1 }, { s5, 5 }, { s8, 8 }, { s4, 4 }, { s3, 3 }, { nullptr, 0 } };
		rn_map<const char[],int>     p1( p );
		...
		rn_map<const char[],int>     q1( p );
		rn_map<const char[],int>     q2( p );
		rn_map<const char[],int>     q3( p );
		rn_map<const char[],int>     q4( p );
...
void dp_maptest::test30()
{
	...
	rr_map<const char[],test*>	m1 = {{ s1, &t1 }, { s2, &t2 }};
	rr_map<const char[],test*>	m2;
	rr_map<const char[],test*>	m3 = {{ s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	...
	// erase
	{
		rd_map<const char[],test*>     p {{ s1, &t1 }, { s5, &t5 }, { s8, &t8 }, { s4, &t4 }, { s3, &t3 }, { nullptr, nullptr } };
		rd_map<const char[],test*>     p1( p );
...
void dp_maptest::test31()
{
	...
	typedef typename dd_map<const char[],test*>::iterator		iterator;
	typedef typename dd_map<const char[],test*>::const_iterator	const_iterator;
	...
	// emplace
	{
		dd_map<const char[],test*>		pm;
		dd_map<const char[],test*>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		dd_map<const char[],test*>		pm;
		dd_map<const char[],test*>		pi;
		dd_map<const char[],test*>		il;
		dd_map<const char[],test*>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		dd_map<const char[],test*>     p {{ s1, &t1 }, { s5, &t5 }, { s8, &t8 }, { s4, &t4 }, { s3, &t3 }, { nullptr, nullptr } };
		dd_map<const char[],test*>     p1( p );
		...
		dd_map<const char[],test*>     q1( p );
		dd_map<const char[],test*>     q2( p );
		dd_map<const char[],test*>     q3( p );
		dd_map<const char[],test*>     q4( p );
...
void dp_maptest::test32()
{
	...
	rr_map<const test[],test*>	m1 = {{ v1, &t1 }, { v2, &t2 }};
	rr_map<const test[],test*>	m2;
	rr_map<const test[],test*>	m3 = {{ v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	...
	// erase
	{
		rd_map<test[],test*>     p {{ v1, &t1 }, { v5, &t5 }, { v8, &t8 }, { v4, &t4 }, { v3, &t3 }, { nullptr, nullptr } };
		rd_map<test[],test*>     p1( p );
...
void dp_maptest::test33()
{
	...
	// erase
	{
		dd_map<test[],test*>     p {{ v1, &t1 }, { v5, &t5 }, { v8, &t8 }, { v4, &t4 }, { v3, &t3 }, { nullptr, nullptr } };
		dd_map<test[],test*>     p1( p );
...
void dp_maptest::test34()
{
	...
	typedef typename rd_map<test[3],test*>::iterator		iterator;
	typedef typename rd_map<test[3],test*>::const_iterator	const_iterator;

	rr_map<const test[3],test*>	m1 = {{ w1, &t1 }, { w2, &t2 }};
	rr_map<const test[3],test*>	m2;
	rr_map<const test[3],test*>	m3 = {{ w2, &t2 }, { w3, &t3 }, { w5, &t5 }};

	// emplace
	{
		rd_map<test[3],test*>		pm;
		rd_map<test[3],test*>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		rd_map<test[3],test*>		pm;
		rd_map<test[3],test*>		pi;
		rd_map<test[3],test*>		il;
		rd_map<test[3],test*>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		rd_map<test[3],test*>     p {{ w1, &t1 }, { w5, &t5 }, { w8, &t8 }, { w4, &t4 }, { w3, &t3 }, { nullptr, nullptr } };
		rd_map<test[3],test*>     p1( p );
		...
		rd_map<test[3],test*>     q1( p );
		rd_map<test[3],test*>     q2( p );
		rd_map<test[3],test*>     q3( p );
		rd_map<test[3],test*>     q4( p );
...
void dp_maptest::test35()
{
	...
	typedef typename dd_map<test[3],test*>::iterator		iterator;
	typedef typename dd_map<test[3],test*>::const_iterator	const_iterator;
	...
	// emplace
	{
		dd_map<test[3],test*>		pm;
		dd_map<test[3],test*>		pi;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// insert
	{
		dd_map<test[3],test*>		pm;
		dd_map<test[3],test*>		pi;
		dd_map<test[3],test*>		il;
		dd_map<test[3],test*>		it;
		std::pair<iterator,bool>	r; 
		const_iterator			j = pi.begin();
	...
	// erase
	{
		dd_map<test[3],test*>     p {{ w1, &t1 }, { w5, &t5 }, { w8, &t8 }, { w4, &t4 }, { w3, &t3 }, { nullptr, nullptr } };
		dd_map<test[3],test*>     p1( p );
		...
		dd_map<test[3],test*>     q1( p );
		dd_map<test[3],test*>     q2( p );
		dd_map<test[3],test*>     q3( p );
		dd_map<test[3],test*>     q4( p );
...
void dp_maptest::test36()
{
	...
	typedef typename nd_map<int,test*>::iterator		iterator;
	typedef typename nd_map<int,test*>::const_iterator	const_iterator;

	nr_map<int,test*>	m1 = {{ 1, &t1 }, { 2, &t2 }};
	nr_map<int,test*>	m2;
	nr_map<int,test*>	m3 = {{ 2, &t2 }, { 3, &t3 }, { 5, &t5 }};
	...
	// erase
	{
		nd_map<int,test*>     p {{ 1, &t1 }, { 5, &t5 }, { 8, &t8 }, { 4, &t4 }, { 3, &t3 }, { 0, nullptr } };
		nd_map<int,test*>     p1( p );
		...
		nd_map<int,test*>     q1( p );
		nd_map<int,test*>     q2( p );
		nd_map<int,test*>     q3( p );
		nd_map<int,test*>     q4( p );
...
void dp_maptest::test37()
{
	...
	rr_map<test*,test*>	     pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	{
		rr_map<test*,test*>::iterator   i;
		rr_map<test*,test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rr_map<test*,test*>::iterator( i );
			if ( c == 2 ) {
	...
	{
		rr_map<test*,test*>::reverse_iterator   i;
		rr_map<test*,test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rr_map<test*,test*>::reverse_iterator( i );
			if ( c == 3 ) {
		...
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rr_map<test*,test*>::const_reverse_iterator>( pm.find( &t2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test38()
{
	...
	dr_map<test*,test*>	     pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	{
		dr_map<test*,test*>::iterator   i;
		dr_map<test*,test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dr_map<test*,test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertEqual( i->second, &t3 );
				AssertEqual( *i->second, t3 );
	...
	{
		dr_map<test*,test*>::reverse_iterator   i;
		dr_map<test*,test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = dr_map<test*,test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
				AssertEqual( i->second, &t1 );
				AssertEqual( *i->second, t1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<dr_map<test*,test*>::const_reverse_iterator>( pm.find( &t2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test39()
{
	...
	rd_map<test*,test*>	     pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	{
		rd_map<test*,test*>::iterator   i;
		rd_map<test*,test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rd_map<test*,test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rd_map<test*,test*>::reverse_iterator   i;
		rd_map<test*,test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rd_map<test*,test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rd_map<test*,test*>::const_reverse_iterator>( pm.find( &t2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test3A()
{
	...
	dd_map<test*,test*>	     pm = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	{
		dd_map<test*,test*>::iterator   i;
		dd_map<test*,test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dd_map<test*,test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertNotEqual( i->second, &t3 );
				AssertEqual( *i->second, t3 );
	...
	{
		dd_map<test*,test*>::reverse_iterator   i;
		dd_map<test*,test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = dd_map<test*,test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
				AssertNotEqual( i->second, &t1 );
				AssertEqual( *i->second, t1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<dd_map<test*,test*>::const_reverse_iterator>( pm.find( &t2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test3B()
{
	...
	rr_map<const char[],const char[]>	     pm = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	{
		rr_map<const char[],const char[]>::iterator   i;
		rr_map<const char[],const char[]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rr_map<const char[],const char[]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rr_map<const char[],const char[]>::reverse_iterator   i;
		rr_map<const char[],const char[]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rr_map<const char[],const char[]>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rr_map<const char[],const char[]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test3C()
{
	...
	rd_map<const char[],const char[]>	     pm = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	{
		rd_map<const char[],const char[]>::iterator   i;
		rd_map<const char[],const char[]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rd_map<const char[],const char[]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rd_map<const char[],const char[]>::reverse_iterator   i;
		rd_map<const char[],const char[]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rd_map<const char[],const char[]>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rd_map<const char[],const char[]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test3D()
{
	...
	rr_map<const char[],test[]>	     pm = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	{
		rr_map<const char[],test[]>::iterator   i;
		rr_map<const char[],test[]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rr_map<const char[],test[]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rr_map<const char[],test[]>::reverse_iterator   i;
		rr_map<const char[],test[]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rr_map<const char[],test[]>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rr_map<const char[],test[]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test3E()
{
	...
	rd_map<const char[],test[]>	     pm = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	{
		rd_map<const char[],test[]>::iterator   i;
		rd_map<const char[],test[]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rd_map<const char[],test[]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rd_map<const char[],test[]>::reverse_iterator   i;
		rd_map<const char[],test[]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rd_map<const char[],test[]>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rd_map<const char[],test[]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test3F()
{
	...
	rr_map<const char[],test[3]>	     pm = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	{
		rr_map<const char[],test[3]>::iterator   i;
		rr_map<const char[],test[3]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rr_map<const char[],test[3]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rr_map<const char[],test[3]>::reverse_iterator   i;
		rr_map<const char[],test[3]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rr_map<const char[],test[3]>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rr_map<const char[],test[3]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test40()
{
	...
	rd_map<const char[],test[3]>	     pm = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	{
		rd_map<const char[],test[3]>::iterator   i;
		rd_map<const char[],test[3]>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rd_map<const char[],test[3]>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rd_map<const char[],test[3]>::reverse_iterator   i;
		rd_map<const char[],test[3]>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rd_map<const char[],test[3]>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rd_map<const char[],test[3]>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test41()
{
	...
	rn_map<const char[],int>	     pm = {{ s1, 1 }, { s2, 2 }, { s3, 3 }, { s5, 5 }};
	{
		rn_map<const char[],int>::iterator   i;
		rn_map<const char[],int>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rn_map<const char[],int>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
	...
	{
		rn_map<const char[],int>::reverse_iterator   i;
		rn_map<const char[],int>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rn_map<const char[],int>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rn_map<const char[],int>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test42()
{
	...
	rd_map<const char[],test*>	     pm = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	{
		rd_map<const char[],test*>::iterator   i;
		rd_map<const char[],test*>::const_iterator     j, k;
		unsigned			c;
...
void dp_maptest::test43()
{
	...
	dd_map<const char[],test*>	     pm = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	{
		dd_map<const char[],test*>::iterator   i;
		dd_map<const char[],test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dd_map<const char[],test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertNotEqual( i->second, &t3 );
				AssertEqual( *i->second, t3 );
	...
	{
		dd_map<const char[],test*>::reverse_iterator   i;
		dd_map<const char[],test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = dd_map<const char[],test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
				AssertNotEqual( i->second, &t1 );
				AssertEqual( *i->second, t1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<dd_map<const char[],test*>::const_reverse_iterator>( pm.find( s2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test44()
{
	...
	rd_map<test[],test*>	     pm = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	{
		rd_map<test[],test*>::iterator   i;
		rd_map<test[],test*>::const_iterator     j, k;
		unsigned			c;
	...
	}
	{
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rd_map<test[],test*>::const_reverse_iterator>( pm.find( v2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test45()
{
	...
	dd_map<test[],test*>	     pm = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	{
		dd_map<test[],test*>::iterator   i;
		dd_map<test[],test*>::const_iterator     j, k;
		unsigned			c;
	...
	}
	{
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<dd_map<test[],test*>::const_reverse_iterator>( pm.find( v2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test46()
{
	...
	rd_map<test[3],test*>	     pm = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	{
		rd_map<test[3],test*>::iterator   i;
		rd_map<test[3],test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = rd_map<test[3],test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertNotEqual( i->second, &t3 );
				AssertEqual( *i->second, t3 );
	...
	{
		rd_map<test[3],test*>::reverse_iterator   i;
		rd_map<test[3],test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = rd_map<test[3],test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
				AssertNotEqual( i->second, &t1 );
				AssertEqual( *i->second, t1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<rd_map<test[3],test*>::const_reverse_iterator>( pm.find( w2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test47()
{
	...
	dd_map<test[3],test*>	     pm = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	{
		dd_map<test[3],test*>::iterator   i;
		dd_map<test[3],test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = dd_map<test[3],test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertNotEqual( i->second, &t3 );
				AssertEqual( *i->second, t3 );
	...
	{
		dd_map<test[3],test*>::reverse_iterator   i;
		dd_map<test[3],test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = dd_map<test[3],test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
				AssertNotEqual( i->second, &t1 );
				AssertEqual( *i->second, t1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<dd_map<test[3],test*>::const_reverse_iterator>( pm.find( w2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test48()
{
	...
	nd_map<int,test*>	     pm = {{ 1, &t1 }, { 2, &t2 }, { 3, &t3 }, { 5, &t5 }};
	{
		nd_map<int,test*>::iterator   i;
		nd_map<int,test*>::const_iterator     j, k;
		unsigned			c;

		for ( i = pm.begin(), c = 0; i != pm.end(); ++i, ++c ) {
			if ( c == 1 ) k = nd_map<int,test*>::iterator( i );
			if ( c == 2 ) {
				AssertNotEqual( i, pm.end());
				AssertNotEqual( i->second, &t3 );
				AssertEqual( *i->second, t3 );
	...
	{
		nd_map<int,test*>::reverse_iterator   i;
		nd_map<int,test*>::const_reverse_iterator     j, k;
		unsigned				c;

		for ( i = pm.rbegin(), c = 0; i != pm.rend(); ++i, ++c ) {
			if ( c == 2 ) k = nd_map<int,test*>::reverse_iterator( i );
			if ( c == 3 ) {
				AssertNotEqual( i, pm.rend());
				AssertNotEqual( i->second, &t1 );
				AssertEqual( *i->second, t1 );
		...
		AssertEqual( i, pm.rend());
		AssertEqual( c, 4 );
		AssertEqual( static_cast<nd_map<int,test*>::const_reverse_iterator>( pm.find( 2 )), j );
		AssertTrue( k != j );
		AssertTrue( ++k == j );
	}
}
...
void dp_maptest::test49()
{
	...
	rr_map<test*,test*>	r1;
	rr_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	rr_map<test*,test*>	r3 = {{ &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test4A()
{
	...
	dr_map<test*,test*>	r1;
	dr_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	dr_map<test*,test*>	r3 = {{ &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test4B()
{
	...
	rd_map<test*,test*>	r1;
	rd_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	rd_map<test*,test*>	r3 = {{ &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test4C()
{
	...
	dd_map<test*,test*>	r1;
	dd_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	dd_map<test*,test*>	r3 = {{ &t4, &t4 }, { &t5, &t5 }};
...
void dp_maptest::test4D()
{
	...
	rr_map<const char[],const char[]>	r1;
	rr_map<const char[],const char[]>	r2 = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	rr_map<const char[],const char[]>	r3 = {{ s4, s4 }, { s5, s5 }};
...
void dp_maptest::test4E()
{
	...
	rd_map<const char[],const char[]>	r1;
	rd_map<const char[],const char[]>	r2 = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	rd_map<const char[],const char[]>	r3 = {{ s4, s4 }, { s5, s5 }};
...
void dp_maptest::test4F()
{
	...
	rr_map<const char[],test[]>	r1;
	rr_map<const char[],test[]>	r2 = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	rr_map<const char[],test[]>	r3 = {{ s4, v4 }, { s5, v5 }};
...
void dp_maptest::test50()
{
	...
	rd_map<const char[],test[]>	r1;
	rd_map<const char[],test[]>	r2 = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	rd_map<const char[],test[]>	r3 = {{ s4, v4 }, { s5, v5 }};
...
void dp_maptest::test51()
{
	...
	rr_map<const char[],test[3]>	r1;
	rr_map<const char[],test[3]>	r2 = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	rr_map<const char[],test[3]>	r3 = {{ s4, w4 }, { s5, w5 }};
...
void dp_maptest::test52()
{
	...
	rd_map<const char[],test[3]>	r1;
	rd_map<const char[],test[3]>	r2 = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	rd_map<const char[],test[3]>	r3 = {{ s4, w4 }, { s5, w5 }};
...
void dp_maptest::test53()
{
	...
	rn_map<const char[],int>	r1;
	rn_map<const char[],int>	r2 = {{ s1, 1 }, { s2, 2 }, { s3, 3 }, { s5, 5 }};
	rn_map<const char[],int>	r3 = {{ s4, 4 }, { s5, 5 }};
...
void dp_maptest::test54()
{
	...
	rd_map<const char[],test*>	r1;
	rd_map<const char[],test*>	r2 = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	rd_map<const char[],test*>	r3 = {{ s4, &t4 }, { s5, &t5 }};
...
void dp_maptest::test55()
{
	...
	dd_map<const char[],test*>	r1;
	dd_map<const char[],test*>	r2 = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	dd_map<const char[],test*>	r3 = {{ s4, &t4 }, { s5, &t5 }};
...
void dp_maptest::test56()
{
	...
	rd_map<test[],test*>	r1;
	rd_map<test[],test*>	r2 = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	rd_map<test[],test*>	r3 = {{ v4, &t4 }, { v5, &t5 }};
...
void dp_maptest::test57()
{
	...
	dd_map<test[],test*>	r1;
	dd_map<test[],test*>	r2 = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	dd_map<test[],test*>	r3 = {{ v4, &t4 }, { v5, &t5 }};
...
void dp_maptest::test58()
{
	...
	rd_map<test[3],test*>	r1;
	rd_map<test[3],test*>	r2 = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	rd_map<test[3],test*>	r3 = {{ w4, &t4 }, { w5, &t5 }};
...
void dp_maptest::test59()
{
	...
	dd_map<test[3],test*>	r1;
	dd_map<test[3],test*>	r2 = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	dd_map<test[3],test*>	r3 = {{ w4, &t4 }, { w5, &t5 }};
...
void dp_maptest::test5A()
{
	...
	nd_map<int,test*>	r1;
	nd_map<int,test*>	r2 = {{ 1, &t1 }, { 2, &t2 }, { 3, &t3 }, { 5, &t5 }};
	nd_map<int,test*>	r3 = {{ 4, &t4 }, { 5, &t5 }};
...
void dp_maptest::test5B()
{
	...
	rr_map<test*,test*>	r1 = {{ &t1, &t1 }, { &t2, &t2 }};
	rr_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	rr_map<test*,test*>	r3 = {{ &t1, &t1 }, { &t3, &t3 }, { &t2, &t2 }};
	rr_map<test*,test*>	r4 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	rr_map<test*,test*>	r5;
...
void dp_maptest::test5C()
{
	...
	dr_map<test*,test*>	r1 = {{ &t1, &t1 }, { &t2, &t2 }};
	dr_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	dr_map<test*,test*>	r3 = {{ &t1, &t1 }, { &t3, &t3 }, { &t2, &t2 }};
	dr_map<test*,test*>	r4 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	dr_map<test*,test*>	r5;
...
void dp_maptest::test5D()
{
	...
	rd_map<test*,test*>	r1 = {{ &t1, &t1 }, { &t2, &t2 }};
	rd_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	rd_map<test*,test*>	r3 = {{ &t1, &t1 }, { &t3, &t3 }, { &t2, &t2 }};
	rd_map<test*,test*>	r4 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	rd_map<test*,test*>	r5;
...
void dp_maptest::test5E()
{
	...
	dd_map<test*,test*>	r1 = {{ &t1, &t1 }, { &t2, &t2 }};
	dd_map<test*,test*>	r2 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	dd_map<test*,test*>	r3 = {{ &t1, &t1 }, { &t3, &t3 }, { &t2, &t2 }};
	dd_map<test*,test*>	r4 = {{ &t1, &t1 }, { &t2, &t2 }, { &t3, &t3 }, { &t5, &t5 }};
	dd_map<test*,test*>	r5;
...
void dp_maptest::test5F()
{
	...
	rr_map<const char[],const char[]>	r1 = {{ s1, s1 }, { s2, s2 }};
	rr_map<const char[],const char[]>	r2 = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	rr_map<const char[],const char[]>	r3 = {{ s1, s1 }, { s3, s3 }, { s2, s2 }};
	rr_map<const char[],const char[]>	r4 = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	rr_map<const char[],const char[]>	r5;
...
void dp_maptest::test60()
{
	...
	rd_map<const char[],const char[]>	r1 = {{ s1, s1 }, { s2, s2 }};
	rd_map<const char[],const char[]>	r2 = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	rd_map<const char[],const char[]>	r3 = {{ s1, s1 }, { s3, s3 }, { s2, s2 }};
	rd_map<const char[],const char[]>	r4 = {{ s1, s1 }, { s2, s2 }, { s3, s3 }, { s5, s5 }};
	rd_map<const char[],const char[]>	r5;
...
void dp_maptest::test61()
{
	...
	rr_map<const char[],test[]>	r1 = {{ s1, v1 }, { s2, v2 }};
	rr_map<const char[],test[]>	r2 = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	rr_map<const char[],test[]>	r3 = {{ s1, v1 }, { s3, v3 }, { s2, v2 }};
	rr_map<const char[],test[]>	r4 = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	rr_map<const char[],test[]>	r5;
...
void dp_maptest::test62()
{
	...
	rd_map<const char[],test[]>	r1 = {{ s1, v1 }, { s2, v2 }};
	rd_map<const char[],test[]>	r2 = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	rd_map<const char[],test[]>	r3 = {{ s1, v1 }, { s3, v3 }, { s2, v2 }};
	rd_map<const char[],test[]>	r4 = {{ s1, v1 }, { s2, v2 }, { s3, v3 }, { s5, v5 }};
	rd_map<const char[],test[]>	r5;
...
void dp_maptest::test63()
{
	...
	rr_map<const char[],test[3]>	r1 = {{ s1, w1 }, { s2, w2 }};
	rr_map<const char[],test[3]>	r2 = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	rr_map<const char[],test[3]>	r3 = {{ s1, w1 }, { s3, w3 }, { s2, w2 }};
	rr_map<const char[],test[3]>	r4 = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	rr_map<const char[],test[3]>	r5;
...
void dp_maptest::test64()
{
	...
	rd_map<const char[],test[3]>	r1 = {{ s1, w1 }, { s2, w2 }};
	rd_map<const char[],test[3]>	r2 = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	rd_map<const char[],test[3]>	r3 = {{ s1, w1 }, { s3, w3 }, { s2, w2 }};
	rd_map<const char[],test[3]>	r4 = {{ s1, w1 }, { s2, w2 }, { s3, w3 }, { s5, w5 }};
	rd_map<const char[],test[3]>	r5;
...
void dp_maptest::test65()
{
	...
	rn_map<const char[],int>	r1 = {{ s1, 1 }, { s2, 2 }};
	rn_map<const char[],int>	r2 = {{ s1, 1 }, { s2, 2 }, { s3, 3 }, { s5, 5 }};
	rn_map<const char[],int>	r3 = {{ s1, 1 }, { s3, 3 }, { s2, 2 }};
	rn_map<const char[],int>	r4 = {{ s1, 1 }, { s2, 2 }, { s3, 3 }, { s5, 5 }};
	rn_map<const char[],int>	r5;
...
void dp_maptest::test66()
{
	...
	rd_map<const char[],test*>	r1 = {{ s1, &t1 }, { s2, &t2 }};
	rd_map<const char[],test*>	r2 = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	rd_map<const char[],test*>	r3 = {{ s1, &t1 }, { s3, &t3 }, { s2, &t2 }};
	rd_map<const char[],test*>	r4 = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	rd_map<const char[],test*>	r5;
...
void dp_maptest::test67()
{
	...
	dd_map<const char[],test*>	r1 = {{ s1, &t1 }, { s2, &t2 }};
	dd_map<const char[],test*>	r2 = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	dd_map<const char[],test*>	r3 = {{ s1, &t1 }, { s3, &t3 }, { s2, &t2 }};
	dd_map<const char[],test*>	r4 = {{ s1, &t1 }, { s2, &t2 }, { s3, &t3 }, { s5, &t5 }};
	dd_map<const char[],test*>	r5;
...
void dp_maptest::test68()
{
	...
	rd_map<test[],test*>	r1 = {{ v1, &t1 }, { v2, &t2 }};
	rd_map<test[],test*>	r2 = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	rd_map<test[],test*>	r3 = {{ v1, &t1 }, { v3, &t3 }, { v2, &t2 }};
	rd_map<test[],test*>	r4 = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	rd_map<test[],test*>	r5;
...
void dp_maptest::test69()
{
	...
	dd_map<test[],test*>	r1 = {{ v1, &t1 }, { v2, &t2 }};
	dd_map<test[],test*>	r2 = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	dd_map<test[],test*>	r3 = {{ v1, &t1 }, { v3, &t3 }, { v2, &t2 }};
	dd_map<test[],test*>	r4 = {{ v1, &t1 }, { v2, &t2 }, { v3, &t3 }, { v5, &t5 }};
	dd_map<test[],test*>	r5;
...
void dp_maptest::test6A()
{
	...
	rd_map<test[3],test*>	r1 = {{ w1, &t1 }, { w2, &t2 }};
	rd_map<test[3],test*>	r2 = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	rd_map<test[3],test*>	r3 = {{ w1, &t1 }, { w3, &t3 }, { w2, &t2 }};
	rd_map<test[3],test*>	r4 = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	rd_map<test[3],test*>	r5;
...
void dp_maptest::test6B()
{
	...
	dd_map<test[3],test*>	r1 = {{ w1, &t1 }, { w2, &t2 }};
	dd_map<test[3],test*>	r2 = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	dd_map<test[3],test*>	r3 = {{ w1, &t1 }, { w3, &t3 }, { w2, &t2 }};
	dd_map<test[3],test*>	r4 = {{ w1, &t1 }, { w2, &t2 }, { w3, &t3 }, { w5, &t5 }};
	dd_map<test[3],test*>	r5;
...
void dp_maptest::test6C()
{
	...
	nd_map<int,test*>	r1 = {{ 1, &t1 }, { 2, &t2 }};
	nd_map<int,test*>	r2 = {{ 1, &t1 }, { 2, &t2 }, { 3, &t3 }, { 5, &t5 }};
	nd_map<int,test*>	r3 = {{ 1, &t1 }, { 3, &t3 }, { 2, &t2 }};
	nd_map<int,test*>	r4 = {{ 1, &t1 }, { 2, &t2 }, { 3, &t3 }, { 5, &t5 }};
	nd_map<int,test*>	r5;
